                          ...
                          children: <Widget>[
                                  ...
                                  Expanded(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Text(controller.state.name.value,
                            ...
                            InkWell(
                              onTap: () {
                                ...
                                Get.toNamed(AppRoutes.MOVIE_SEARCH_SCREEN);
                              },
                              child: Hero(
                                tag: 'searchHero',
                                child: Material(
                            ...
                            if (controller.state.isLoading.value == true)
                              const Padding(
                              ...
                              Column(
                                children: [
                                  MostPopularMovies(
                                      movieList:
                                          controller.state.obs.value.movieList),
                                  MenuActions(actions: controller.state.genres),
                                  UpcomingMovies(
                                      comingUpMovieList: controller
                                          .state.obs.value.comingUpMovieList),
                                ],
                              )
                          ],
                        ),
